...
def main():
	parser = argparse.ArgumentParser(description='Translate text repeatedly using Google Translate. For the keks and memes. Made into a bot by BK-Modding')
	...
	print('[*] "{}" but translated {} times!'.format(text.strip(), args.num*len(args.langs)))
